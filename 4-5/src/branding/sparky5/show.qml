 ...
 *   Copyright 2017, Paweł Pijanowski <pavroo@onet.eu>
 *
...
Presentation
{
    ...
    Slide {
        ...
        Text {
            ...
            wrapMode: Text.WordWrap
            text: "<ul>" +
                  " <li>Firefox, Thunderbird, LibreOffice, Pidgin and HexChat come pre-installed in Sparky, so you can get started immediately with the desktop and the Internet.</li>" +
